...
const FormOp2 = () => {
  ...
  const [valorUnidad, setValorUnidad] = useState(20000);
  const [valorPrestamo, setValorPrestamo] = useState(10000);
  ...
  const [excesoCuotasEdad, setExcesoCuotasEdad] = useState(false);
  ...
  useEffect(() => {
    // setCuota(calcularCuota(valorPrestamo, tasaAnual, plazoFinanciamiento));
    setIngresosTotales(
      calcularIngresos(
    ...
    // calcularEdad(edad, plazoFinanciamiento) > 70 ? setExcesoCuotasEdad(true) : setExcesoCuotasEdad(false)
    setIngresosTotales(
      calcularIngresos(
        ingresosNetosMensuales,
        ingresosNetosMensuales2,
    ...
    <form onSubmit={handleSubmit} className=" mx-auto">
      ...
      {parteDelFormulario < 3 && (
        <NextButton
          ...
          disabled={calcularEdad(birthday, plazoFinanciamiento) > 70 || !edad}
        />
      )}
    </form>
  );
